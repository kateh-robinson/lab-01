...
**No value/not assigned, some values missing**
...
**na.rm says whether or not na values should be removed from the calculation**
...
**Some places have a very large amount of visitors (millions) which skews the data.**
...
visitors_with_nations %>% 
  group_by(nation) %>% count(admission=="Free")
